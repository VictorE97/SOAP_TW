...
$idJugador = isset($_POST['idJugador'])? $_POST['idJugador'] : '';
...
$oSoap = new nusoap_client ('http://localhost:8080/2020TW/Servicio/actualizarJugador.php?wsdl');
...
$resultado = $oSoap->call('actualizarJugador',array('nombre' => $nombre,'foto' => $foto,'nick' => $nick,'numJugador' => $numJugador,'posicion' => $posicion,'idEquipo' => $idEquipo),'http://localhost/2020TW/Servicio/actualizarJugador'); //Nuevamente la ubicacion de tu archivo PHP
...
<body>
	...
	<div>
		<form action="#" method="POST" name='actualizarJugador'>
		    <div>
				<label>idJugador</label>
				<input type="text" name="idJugador" id="idJugador" placeholder="idJugador" required>
			</div>
			<div>
				<label>Nombre:</label>
			...
			<button type="submit" name="sub">Actualizar jugador</button>
		</form>		
